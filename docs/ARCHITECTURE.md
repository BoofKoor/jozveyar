...
| ۳ب | سرور: کد پیامکی با پیامک کنسولی، نشست، ساخت سفارش، درگاه نمونه و برگشت از آن، کار `prepare_order` کارگر، `CHECKOUT_MODE`. روی سایت زنده خاموش | #35، ساخته شد (پایین) |
