...
| ۳ج | رابط: اجزای تازهٔ کیت و دو آیکون، قدم‌ها طبق طرح، درگاه نمونه، صفحهٔ سفارش، حالت `off` سایت زنده؛ مرحلهٔ تازهٔ CI: تست سرتاسری با پستگرس، Garage و کارگر واقعی | #36، ساخته شد (پایین) |
