...
| 4 | پنل ادمین نسخهٔ ۱ | TOTP روی ساب‌دامین جدا، فهرست و جزئیات سفارش، دانلود فایل، تغییر وضعیت، ویرایش تعرفه، ساعت SLA؛ و به خواستهٔ صاحب پروژه (۱۴۰۵/۰۷/۰۴) کلیدها و تنظیمات سرویس‌های بیرونی (پیامک، درگاه) که امروز در `.env`اند، دیدنی و تغییرپذیر از پنل |
...
تغییرپذیرند (خواستهٔ ۱۴۰۵/۰۷/۰۴، برنامه‌اش در برش ۴).
